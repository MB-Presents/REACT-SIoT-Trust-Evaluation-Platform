...
from core.models.events.simulation_events import SimulationEventManager, VerificationState

from core.models.devices.common import DeviceBehaviour, DeviceRecordType, DeviceType
...
class TrafficLightSystem(GenericDevice):
    ...
    def __init__(self, 
        ...
        super().__init__(   device_id=traffic_light_id,
        ...
        # self.report_manager = EmergencyReportManagementService()
            ...
            if report.trustworthiness != VerificationState.UNVERIFIED and report.event_status == RequestLifecycleStatus.FINISHED: 
                ...
                for sender_id, sending_vehicles in report.sending_entities.items():
                    ...
                    if distance <= 10:
                        ...
                        print(f"Traffic light {report.receiving_entity._id} - Authenticity:  {report.trustworthiness} at {report._timestamp} with trustworthiness {report.trustworthiness} and distance {distance}")
                        




    def update_traffic_light_schedule(self, report : SendingPacket):
...
class TrafficLightManager:
    ...
    def __init__(self, device_handler : DevicesGroupHandler):
    ...
    def subscribe(self):
        ...
        for traffic_light_id in trafficlights:
            traci.trafficlight.subscribe(traffic_light_id, ScenarioDeviceConfiguration.TRAFFIC_LIGHT_FEATURES)
