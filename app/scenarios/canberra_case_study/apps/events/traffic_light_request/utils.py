...
def met_time_and_vehicles_preconditions():
    ...
    vehicles_simulation = devices.get_devices_by_group(DeviceType.VEHICLE)
    return ScenarioParameters.TIME % Settings.INTERVAL_OF_FALSE_TRAFFIC_LIGHT_REQUESTS == 0 and len(vehicles_simulation) > 0
