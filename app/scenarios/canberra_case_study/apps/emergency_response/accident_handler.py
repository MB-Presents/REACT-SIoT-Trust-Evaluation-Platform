...
# from scenarios.canberra_case_study.apps.emergency_response.emergency_vehicle import EmergencyReportRecord, EmergencyVehicle
...
#         for emergency_vehicle_key, emergency_vehicle in DevicesGroupHandler().get_devices_by_group(DeviceType.EMERGENCY_VEHICLE):
...
#             vehicles = accident.assigned_emergency_vehicle.devices.get_devices_by_group(DeviceType.VEHICLE)
