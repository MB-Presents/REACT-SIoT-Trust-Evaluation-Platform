...
from trust.data_models.ITransactionUpdate import ITransactionUpdate
...
class ReputationController(ITransactionUpdate):
    ...
    def get_local_reputation(self, transaction : Union[Transaction,DirectRecommendation]):    
        ...
        if self.reputation_computation_strategy == ReputationComputationStrategy.AVERAGE_OF_LAST_N_TRANSACTIONS:
